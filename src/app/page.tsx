                  ...
                  <div className="grid md:grid-cols-3 gap-8">
                      ...
                      <Card className="border-2 hover:border-secondary transition-all hover-scale">
                          <CardHeader>
                              ...
                              <CardDescription>
                                  მიიღე მონაწილეობა ყოველკვირეულ ტურნირებში და იბრძოლე ღირსებისთვის
                              </CardDescription>
                          </CardHeader>
                      </Card>
                      ...
                      <Card className="border-2 hover:border-accent transition-all hover-scale">
                          <CardHeader>
                              ...
                              <CardDescription>
                                  იპოვე თანაგუნდელები რეიტინგული და არარეიტინგული მატჩებისთვის ნებისმიერ დროს
                              </CardDescription>
                          </CardHeader>
                      </Card>
                  </div>
              ...
              <div className="container mx-auto max-w-6xl">
                  <div className="grid md:grid-cols-3 gap-8 text-center">
                      ...
                      <div className="space-y-2">
                          ...
                          <p className="text-xl text-muted-foreground">ჩატარებული ტურნირი</p>
                      </div>
                      <div className="space-y-2">
                          <p className="text-5xl font-bold text-accent">24/7</p>
                          <p className="text-xl text-muted-foreground">აქტიური მოთამაშეები</p>
                      </div>
                  </div>
              </div>
          </section>
              ...
              <div className="container mx-auto max-w-4xl">
                  <Card className="border-2 border-primary/20 bg-gradient-to-br from-primary/5 to-secondary/5">
                      <CardContent className="pt-6 text-center space-y-6">
                          <h2 className="text-4xl font-bold text-foreground">მზად ხარ შემოგვიერთდე?</h2>
                          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                              დამწყები თუ პროფესიონალი, ყველას შეუძლია ჩვენი ქომუნითის ნაწილი გახდეს.
                          </p>
                          <Button
                              asChild
                              size="lg"
