        ...
        <div className="min-h-screen bg-background">
            ...
            <div className="container mx-auto px-4 py-8">
                <div className="mb-12 text-center">
                    <h1 className="text-4xl md:text-5xl font-bold mb-4">Georgian AoE II Players</h1>
                    <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                        Meet the top Age of Empires II players from Georgia&#39;s competitive community
                    </p>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {players.map((player) => (
                        <Card key={player.id} className="overflow-hidden hover:shadow-lg transition-shadow pt-0">
                            ...
                            <CardContent className="p-6">
                                <div className="space-y-4">
                                    ...
                                    <div className="pt-2 border-t border-border">
                                        <p className="text-sm text-muted-foreground mb-1">Favorite Civilization</p>
