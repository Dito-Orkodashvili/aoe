        ...
        <div className="min-h-screen bg-background">
            ...
            <section className="py-16 px-4 bg-gradient-to-br from-primary/10 via-background to-secondary/10">
                <div className="container mx-auto max-w-6xl text-center space-y-4">
                    ...
                    <h1 className="text-5xl md:text-6xl font-bold text-foreground">ტურნირები</h1>
            ...
            <section className="py-16 px-4">
                <div className="container mx-auto max-w-6xl">
                    <div className="flex items-center gap-3 mb-8">
                        ...
                        <h2 className="text-4xl font-bold text-foreground">მომავალი ტურნირები</h2>
                    </div>
            ...
            <section className="py-16 px-4 bg-muted/50">
                <div className="container mx-auto max-w-6xl">
                    <div className="flex items-center gap-3 mb-8">
                        ...
                        <h2 className="text-4xl font-bold text-foreground">Past Champions</h2>
                    </div>
